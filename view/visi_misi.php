...
<body>
    ...
    <!-- Visi & Misi Section -->
    <section class="visi_misi container mt-5">
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-primary">Visi & Misi Desa</h4>

                <p class="text-abu mt-3">Menu Visi Misi Desa, adalah menu yang berisi informasi terkait VISI MISI Desa
                    yang
                    tertuang dalam
                    RPJMDES yang merupakan arah pembangunan desa selama kepala desa menjabat atau 6 tahun kedepan.
                    <br><br>
                    Visi adalah suatu pandangan ke depan tentang arah, target, cita-cita, tujuan pada suatu lembaga,
                    perusahaan, organisasi dan lain-lain, lebih sederhananya visi dapat di artikan sebagai suatu tujuan
                    perusahaan, organisasi atau lembaga, mengenai apa yang harus dilakukan untuk mencapai tujuannya di
                    masa yang akan datang atau masa depan.
                    <br><br>
                    Misi adalah suatu pernyataan tentang apa yang harus dikerjakan oleh perusahaan, organisasi atau
                    lembaga sebagai upaya untuk mewujudkan Visi. Misi dapat di artikan sebagai tujuan dan alasan mengapa
                    perusahaan, organisasi atau lembaga itu dibuat. Misi akan memberikan arah sekaligus batasan-batasan
