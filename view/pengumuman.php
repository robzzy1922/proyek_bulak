<?php
 ...
 $sql = "SELECT COUNT(id) AS total FROM pengumuman";
 ...
 $sql = "SELECT id, judul, created_at, konten, image FROM pengumuman ORDER BY created_at DESC LIMIT $starting_limit, $results_per_page";
 $result = mysqli_query($conn, $sql);
 ?>
            ...
            <section class="news-list col-md-8">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<div>';
                        echo '<h3> <a href="../view/isi_pengumuman.php?id=' . $row["id"] . '" style="text-decoration: none;">' . $row["judul"] . '</a></h3>';
                        ...
                        echo '<a href="../view/isi_pengumuman.php?id=' . $row["id"] . '" class="btn btn-primary">selengkapnya</a>';
                        echo '</div>';
                        echo '</article>';
                    }
                } else {
